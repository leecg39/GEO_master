...
export function LearnClient() {
  ...
  const [resetTarget, setResetTarget] = useState<{ reset: "all" } | { reset: "category"; category: string } | null>(null);
  const load = async () => {
