...
const initial: SettingsState = { brandName: "", category: "", competitors: [], activeProject: { id: 0, name: "", brandName: "", category: "", competitors: [], updatedAt: "" }, models: defaultModels, repetitions: defaultRepetitions, modelWeights: defaultModelWeights, apiKeys: { openai: { configured: false, preview: null, error: false }, anthropic: { configured: false, preview: null, error: false }, gemini: { configured: false, preview: null, error: false }, grok: { configured: false, preview: null, error: false } }, subscriptionPin: { configured: false, preview: null, error: false }, updatedAt: "" };
