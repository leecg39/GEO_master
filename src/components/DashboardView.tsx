...
interface DashboardData {
  ...
  trends: { month: string; overall: number; openai: number | null; anthropic: number | null; gemini: number | null; hyperclova: number | null }[];
